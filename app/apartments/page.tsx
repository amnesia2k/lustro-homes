        ...
        <div className="absolute inset-0 bg-linear-to-b from-black/60 to-black/30 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <p className="text-xl max-w-2xl mx-auto">
              Discover our collection of uniquely themed luxury apartments
            </p>
          </div>
        </div>
      </section>
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Link
                      ...
                      className="px-5 py-3 rounded-full transition-all duration-300 font-medium bg-[#b3941f] text-white hover:bg-[#b3941f]/80 cursor-pointer text-center text-sm"
                    >
                      View Details
                    </Link>
                  </div>
