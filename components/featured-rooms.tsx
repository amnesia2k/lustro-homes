...
const rooms = [
  {
    ...
    description:
      "Experience the glamour and luxury of Beverly Hills in this opulent suite.",
    price: 120000,
  ...
  },
  {
    ...
    description:
      "A serene white and blue themed apartment inspired by the Greek islands.",
    price: 80000,
    image: "/placeholder.svg?height=600&width=800",
    rating: 4.8,
    reviews: 98,
  },
  {
    ...
    description:
      "Elegant and sophisticated space reminiscent of Monaco's famous district.",
    price: 70000,
    image: "/placeholder.svg?height=600&width=800",
    rating: 5.0,
    reviews: 87,
  },
  {
    ...
    description:
      "Tropical-inspired apartment with the relaxing vibes of the Seychelles islands.",
    price: 80000,
    image: "/placeholder.svg?height=600&width=800",
    rating: 4.7,
    reviews: 76,
  },
  {
    ...
    description:
      "Unique and exotic apartment inspired by the magical landscapes of Turkey.",
    price: 60000,
    image: "/placeholder.svg?height=600&width=800",
    rating: 4.8,
    reviews: 65,
  },
  {
    ...
    name: "Mykonos Escape",
    description:
      "Contemporary Mediterranean style with the vibrant energy of Mykonos.",
    price: 60000,
    image: "/placeholder.svg?height=600&width=800",
    rating: 4.9,
    reviews: 92,
...
const FeaturedRooms = () => {
  ...
  const nextSlide = () => {
    setStartIndex((prevIndex) =>
      prevIndex + visibleRooms >= rooms.length ? 0 : prevIndex + visibleRooms
    );
  };

  const prevSlide = () => {
    setStartIndex((prevIndex) =>
      prevIndex - visibleRooms < 0
        ? Math.max(0, rooms.length - visibleRooms)
        : prevIndex - visibleRooms
    );
  };
        ...
        <div className="flex justify-between items-center mb-12">
          <div>
            ...
            <p className="text-neutral-600 max-w-2xl">
              Discover our collection of uniquely themed luxury apartments, each
              offering a distinct experience inspired by exotic global
              destinations.
            </p>
          </div>
